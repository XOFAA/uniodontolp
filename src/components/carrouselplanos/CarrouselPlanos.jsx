      ...
      <Container>
        ...
        <Box
          ...
          >
            ...
            <Typography sx={{fontSize:'18px',fontWeight:'bolder',fontStyle:'italic',color:'#A60069'}}>Clique nas setas para ver mais planos</Typography>
            ...
            {planos.map((plan, index) => (
              <SwiperSlide  key={index}>
                ...
                <Box 
                  ...
                  <Card sx={{width:'260px',cursor:'pointer'}}>
          ...
          <Box sx={{display:'flex',justifyContent:'center',gap:5,mt:3}}>
            <Button sx={{bgcolor:'#60EBFF',width:'460px',color:'#363636',fontSize:'18px',fontWeight:'bolder',fontStyle:'italic',textTransform:'none'}}>Possui empresa?</Button>
            <Button sx={{bgcolor:'#E1FF7B',width:'556px',color:'#363636',fontSize:'18px',fontWeight:'bolder',fontStyle:'italic',textTransform:'none'}}>Servidor da Prefeitura de Manaus ou Governo do Estado?</Button>
          </Box>
        </Box>
