...
export const BoxAcessos = () => {
    return (
        <Container sx={{mt:{xs:20,md:4}}} >
            ...
            <Box sx={{ display: 'flex',flexDirection:{xs:'column',md:'row'}, alignItems:'center',justifyContent: 'space-between',mt: 3,gap:{xs:2,md:0}}}>
            <Link href="https://tiss.uniodontomanaus.com.br/SolucoesExtras/consultaBeneficiarios/InformacaoDados.aspx">
